    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
            <svg className="animate-spin h-10 w-10 text-cyan-400 mx-auto mb-4" xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center min-h-screen text-red-400">
        <div className="bg-[#2a2d5a]/50 border border-red-700/50 p-6 rounded-lg text-center backdrop-blur-sm">
